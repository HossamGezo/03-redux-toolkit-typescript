...
const CakeView = () => {
  ...
  return (
    <div className="cake-view w-fit mx-auto">
      <h1 className="cake-header text-5xl text-center mb-10 bg-red-300 text-white py-3 rounded-md w-100 mx-auto max-sm:max-w-90">
        Buy Cake
      </h1>
      <div className="cake-view-wrapper flex items-center gap-5 max-md:flex-col">
