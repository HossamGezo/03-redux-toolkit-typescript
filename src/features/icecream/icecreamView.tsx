...
const IcecreamView = () => {
  ...
  return (
    <div className="icecream-view w-fit mx-auto">
      <h1 className="icecream-header text-5xl text-center mb-10 bg-red-300 text-white py-3 rounded-md w-100 mx-auto">
        Buy Icecream
      </h1>
      <div className="icecream-view-wrapper flex items-center gap-5">
